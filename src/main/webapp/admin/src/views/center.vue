<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='shangjia'"  label='农户名称' prop="shangjiaName">
               <el-input v-model="ruleForm.shangjiaName"  placeholder='农户名称' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='shangjia'"  label='农户星级类型' prop="shangjiaXingjiTypes">
                 <el-select v-model="ruleForm.shangjiaXingjiTypes" placeholder='请选择农户星级类型'>
                     <el-option
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='shangjia'"  label='现有余额' prop="newMoney">
               <el-input v-model="ruleForm.newMoney"  placeholder='现有余额' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="24">
             <el-form-item v-if="flag=='shangjia'"  label="农户简介" prop="shangjiaContent">
                 <editor
