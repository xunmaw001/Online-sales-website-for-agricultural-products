    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="农户名称" prop="shangjiaName">
                       <el-input v-model="ruleForm.shangjiaName"
                                 placeholder="农户名称" clearable  :readonly="ro.shangjiaName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="农户名称" prop="shangjiaName">
                           <el-input v-model="ruleForm.shangjiaName"
                                     placeholder="农户名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="农户星级类型" prop="shangjiaXingjiTypes">
                        <el-select v-model="ruleForm.shangjiaXingjiTypes" :disabled="ro.shangjiaXingjiTypes" placeholder="请选择农户星级类型">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="农户星级类型" prop="shangjiaXingjiValue">
                        <el-input v-model="ruleForm.shangjiaXingjiValue"
                            placeholder="农户星级类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="农户简介" prop="shangjiaContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangjiaContent" label="农户简介" prop="shangjiaContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangjiaXingjiTypes: [
                              { required: true, message: '农户星级类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   shangjiaContent: [
                              { required: true, message: '农户简介不能为空', trigger: 'blur' },
                          ],
                   shangjiaDelete: [
